...
from mundo import Escenario
from ui import HUD
from items import Tesoro, TrampaExplosiva
from sistemas import SistemaCombate
...
class Juego(arcade.Window):
    ...
    def _crear_sprite_jugador(self):
        ...
        sprite = arcade.SpriteSolid(40, 40, arcade.color.BLUE)
    ...
    def _crear_sprite_enemigo(self, enemigo: Enemigo, color):
        ...
        size = 35
        sprite = arcade.SpriteSolid(size, size, color)
    ...
    def _crear_sprite_item(self, color):
        ...
        sprite = arcade.SpriteSolid(20, 20, color)
        return sprite
